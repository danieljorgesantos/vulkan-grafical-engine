...
/*
 * This file manages the creation and management of Vulkan graphics pipelines.
 * Graphics pipelines define how rendering is performed in the Vulkan API,
 * including shaders, vertex input, rasterization, and fragment processing.
 *
 * Key responsibilities of this file:
 * - Initializing graphics pipeline creation logic.
 * - Cleaning up resources associated with graphics pipelines.
 * - Encapsulating logic in the CreateGraphicsPipeline namespace.
 */
...
VkShaderModule createShaderModule(const std::vector<char>& code) {
    ...
    if (vkCreateShaderModule(CreateLogicalDevice::device, &createInfo, nullptr,
...
void createGraphicsPipeline() {
    ...
    multisampling.rasterizationSamples = PickPhysicalDevice::msaaSamples;
...
// Function to cleanup resources related to CreateGraphicsPipeline
void cleanup() {
    std::cout
        << "cleanup() CreateGraphicsPipeline systems cleaned up successfully."
        << std::endl;
}
